...
# 페이지들 로드
urls = ['https://e.kakao.com/api/v1/items/t/baby-choonsik-2']  # 크롤링할 URL 리스트
...
for url in urls:
    ...
    for idx, img_url in enumerate(thumbnail_urls):
        file_name = os.path.join(item_folder, f"image_{idx+1}.jpg")
...
with open("kakao_emoticons_data.json", "w", encoding="utf-8") as json_file:
